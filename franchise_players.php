...
#}
$id=$_GET["id"];
$sql_1="SELECT * FROM player12 WHERE F_ID='$id'";
$sql_2="SELECT * FROM franchise WHERE F_ID='$id'";
$sql_3="SELECT * FROM coach WHERE T_ID='$id'";
...
<body>
    ...
    <div class="page-container"> <div class="image-container">
       <img src="img/<?=$id?>.jpg">
    </div><hr>
    <h2><?php echo $team["TEAM_NAME"];?></h2>
    <hr>
    <div class="data">
    <span class="col-md-4 divi"><?php echo "CAPTAIN:".$team['TEAM_CAPTAIN'];?></span>
    <span class="col-md-4 divi"> <?php echo "MATCHES:".$team['MATCHESF'];?></span>
     <span class="col-md-4 divi"><?php  echo "WINS:".$team['WINSF'];?></span>
     <hr>
</div>
      <?php
         $s=0;
        foreach ($players as $player) {
            #$team_images = glob("img/".$team["F_ID"]."/".$s."*");
        ?>
            <div class="team-card row">
                
                <div class="image-container col-md-4">
                <a href="players.php?id=<?= $player['P_ID'] ?>">
                <img class="image" src="img/<?=$player['P_ID']?>.jpg">
                </a>
                </div>
